...
class TestGPUNewOps:
    ...
    def test_gpu_matmul_bias_relu_exact_tile(self):
        rng = np.random.default_rng(321)
        x_arr = rng.standard_normal((16, 32), dtype=np.float32)
        w_arr = rng.standard_normal((32, 16), dtype=np.float32)
        b_arr = rng.standard_normal(16, dtype=np.float32)
